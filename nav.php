...
<head>
    ...
    <title>Shop & Chill - Product Page</title>
                ...
                <form class="d-flex">
                 ...
                 <button class="btn btn-outline-primary" type="submit">Search</button>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item"> <a class="nav-link active" aria-current="page" href="#">Help</a>
                            <li class="nav-item"> <a class="nav-link active" aria-current="page" href="home.php">Home</a>

                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    
                               <?php  echo $_SESSION['myfirstname']. " ".$_SESSION['mylastname']; ?>
                            </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="customerlogout.php">Logout</a></li>
            <li><a class="dropdown-item" href="#">Notification</a></li>
            <li><a class="dropdown-item" href="editprofile.php?id=<?php echo$id ?>">Edit Profile</a></li>
             <li><a class="dropdown-item" href="customerprofile.php?id=<?php echo$id ?>">View Profile</a></li>
          </ul>
        </li>
              </li>
                 <li class="nav-item"> <a class="nav-link" href="cart.php"><i class="fa-solid fa-cart-shopping"><span class="badge bg-danger">1</span></i></a></li>     
                </ul>
