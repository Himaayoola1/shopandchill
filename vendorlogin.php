...
<head>
    ...
    <title>Shop & Chill - Vendor Login</title>
      ...
      <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="p-5">
                                  <div class="text-center">
                                      ...
                                      <h3 class="vendor text-center">Vendor Login</h3>
        ...
        if($_SERVER['REQUEST_METHOD'] =='POST'){
          ...
          $myadmin= new Vendor;
            ...
            $message =$myadmin->vendorLogin($email,$password);
            ...
            ?>
                                  <form id="loginform" action="" method="post" name="vendorloginform">
                                      <div>
                                  ...
                                  <div class="text-center">
                                      <a class="small mt-3" href="vendorregister.php">Create an Account</a>
                                  </div>
                                  <div class="text-center">
