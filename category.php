...
<div class="row">
      ...
      $result= $cat->displayAllCat($proid);
      if($_SERVER['REQUEST_METHOD']=='POST'){
         if(!empty($_POST['quantity'])){
        $sendOrders=$cat->customerOrder($_POST['productid'],$_POST['custid'],$_POST['quantity'], $_POST['vendor']);
        $results= $cat->insertCart($_POST['productid'],$_POST['custid'],$_POST['quantity'], $_POST['vendor']);
        if($result==true){
