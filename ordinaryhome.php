 ...
 ?>
    ...
    <?php $image =$value['product_image'];
            ...
            <div class="card-body">
                ...
                <button type='submit' name='submit' class='btn btn-primary'> <a href="product.php?id=<?php echo $id; ?>" style='color:white; text-decoration: none;'> View Details</a></button>
                <button type='submit'  id='buttontwo'  name='submit' class='btn btn-secondary text-light'><a href="category.php?id=1" style='color:white; text-decoration: none;'> View All</a></button>
